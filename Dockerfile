...
RUN apt-get update && apt-get install -y bowtie samtools bcftools bedtools emboss python-pip python-numpy wget zlib1g-dev emacs bc gawk vcftools r-cran-ggplot2 curl libcurl4-openssl-dev libssl-dev gnuplot
